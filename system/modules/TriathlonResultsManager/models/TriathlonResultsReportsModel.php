...
/**
 * Class TriathlonResultsReportsModel
 *
 * @copyright  Cliff Parnitzky 2015
 * @author     Cliff Parnitzky
 * @package    Models
 */
class TriathlonResultsReportsModel extends \Model
{
	 ...
	 * @var string
	 */
	protected static $strTable = 'tl_triathlon_results_reports';
	
	/**
	 * Find all active results reports
	 *
	 * @param array $arrOptions An optional options array
	 *
	 * @return \Model\Collection|null A collection of models or null if there are no active results reports
	 */
