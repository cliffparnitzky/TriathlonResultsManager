...
/**
 * Class ModuleTriathlonResultsManagerMyResults
 *
 * Front end module "triathlonResultsManagerMyResults".
 * @copyright  Cliff Parnitzky 2015
 * @author     Cliff Parnitzky
 * @package    Controller
 */
class ModuleTriathlonResultsManagerMyResults extends \ModuleTriathlonResultsManagerResults
{
	 ...
	 * @var string
	 */
	protected $strTemplate = 'mod_triathlonResultsManagerMyResults';
	...
	public function generate()
	{
		if (TL_MODE == 'BE')
		{
			...
			$objTemplate->wildcard = '### ' . utf8_strtoupper($GLOBALS['TL_LANG']['FMD']['triathlonResultsManagerMyResults'][0]) . ' ###';
	...
	protected function compile()
	{
		...
		else
		{
			...
			$this->triathlonResultsManagerFilterResultMember = $this->User->id;
		}
		parent::compile();
	}
}
